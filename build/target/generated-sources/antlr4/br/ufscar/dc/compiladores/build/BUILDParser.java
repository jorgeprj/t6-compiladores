...
public class BUILDParser extends Parser {
	...
	public static class CmdCorteContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BUILDListener ) ((BUILDListener)listener).enterCmdCorte(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BUILDListener ) ((BUILDListener)listener).exitCmdCorte(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BUILDVisitor ) return ((BUILDVisitor<? extends T>)visitor).visitCmdCorte(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Tipo_corteContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BUILDListener ) ((BUILDListener)listener).enterTipo_corte(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BUILDListener ) ((BUILDListener)listener).exitTipo_corte(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BUILDVisitor ) return ((BUILDVisitor<? extends T>)visitor).visitTipo_corte(this);
			else return visitor.visitChildren(this);
		}
	}
