...
cmd: cmdAparafuse | cmdCozinhe | cmdMisture | cmdCorte | cmdBata | cmdTeste | cmdEtapa | cmdPao_de_Lo | cmdCobertura | cmdArroz | cmdCadeira;
cmdAparafuse: 'aparafuse' '(' PECA ')';
cmdCozinhe: 'cozinhe' '(' PECA ',' tempo ')';
cmdMisture: 'misture' '(' PECA (',' PECA)+ ')';
cmdCorte: 'corte' '(' PECA ',' tipo_corte ')';
cmdBata: 'bata' '(' PECA (',' PECA)+ ')';
